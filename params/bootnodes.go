...
// MainnetEthPoWBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main Ethereum network.
var MainnetEthPoWBootnodes = []string{
	// Ethereum Foundation Go Bootnodes
